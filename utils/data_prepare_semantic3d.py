...
grid_size = 0.06
dataset_path = '/share/group/datanlpr9/data/semantic3d/original_data'
...
for pc_path in glob.glob(join(dataset_path, '*.txt')):
    # if pc_path != '/share/group/datanlpr9/data/semantic3d/original_data/neugasse_station1_xyz_intensity_rgb.txt':
    #     continue
    print(pc_path)
